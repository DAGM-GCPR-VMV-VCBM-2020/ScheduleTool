...
"""
This creates a label for the timeslots from 8:00 to 18:30 in 30 minutes steps 
"""
def createGrid():
    out = ''
    for i in range(8 , 18):
...
if __name__ == '__main__':
    ...
    ts = time.gmtime()
    out = "<!--CSS Grid Time Table by Jules Kreuer, Autogenerated on " + str(time.strftime("%Y-%m-%d %H:%M:%S", ts)) + ' -->\n\n'
